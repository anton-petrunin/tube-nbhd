...
Therefore, \textit{\ref{item:1/2B}} and \ref{eq:dist-G} imply the following.
...
\textit{Moreover, if $\Gamma_1,\Gamma_2,\dots$ be a sequence of connected graphs with bounded degrees.
Then there is a connected graph $\Delta$ of degree $\le 3$ such that for any $i$ there is no map $f\:\Vert \Delta\to \Vert \Gamma_i$ with above properties.}
